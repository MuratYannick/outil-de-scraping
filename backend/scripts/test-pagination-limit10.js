/**
 * Script de test pour vérifier la pagination avec limit=10 (comme le frontend)
 * Teste si les prospects apparaissent en double sur différentes pages
 */

import { Prospect, Tag } from '../src/models/index.js';

console.log('🧪 Test de pagination (limit=10)\n');
...
async function testPagination() {
  try {
    ...
    if (duplicates.length > 0) {
      ...
      console.log('═'.repeat(80));
      console.log('✅ TEST RÉUSSI: La pagination fonctionne correctement (limit=10)');
      process.exit(0);
    }
